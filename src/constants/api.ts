...
export const ALL_POSTS_REQUEST_URL = `${process.env.NEXT_PUBLIC_SERVER_URL}${POSTS_PATH}`;
export const ALL_POSTS_REQUEST_URL_WITH_LIMIT = `${process.env.NEXT_PUBLIC_SERVER_URL}${POSTS_PATH}?_limit=${ALL_POSTS_LIMIT}`;
