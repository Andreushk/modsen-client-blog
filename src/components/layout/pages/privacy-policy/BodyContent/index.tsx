  ...
  <section className={styles.body_content}>
    <div>
      ...
      <Paragraph style="dark">
        ...
        incididunt ut labore et dolore magna aliqua. Non blandit massa enim nec. Scelerisque viverra
        mauris in aliquam sem. At risus viverra adipiscing at in tellus. Sociis natoque penatibus et
